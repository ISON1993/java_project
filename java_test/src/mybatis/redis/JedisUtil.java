...
public class JedisUtil {
    ...
    public JedisUtil() throws Exception {
    ...
    public Object getObject(Object key){
        Jedis jedis = pool.getResource();
        Object result = SerializeUtils.unserialize(jedis.get(SerializeUtils.serialize(key)));
        jedis.close();
        return result;
    }
    ...
    public Object removeObject(Object key){
        Jedis jedis = pool.getResource();
        Long result = jedis.del(JSONObject.toJSONString(key));
        jedis.close();
        return result;
    }
